...
class GroupRepository {
  ...
  void getGroupId() async {
    ...
    var currentUserMap = await firestore.collection('users').doc(auth.currentUser!.uid).get();
    ...
    final myGroupId = currentUser.groupId;
    var currentGroupMap =   await firestore.collection('users').doc(myGroupId[0]).get();
  }
